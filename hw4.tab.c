...
{
       0,     0,     3,     7,     9,    12,    14,    16,    19,    23,
      26,    28,    30,    32,    35,    37,    40,    42,    44,    46,
      49,    51,    53,    55,    57
};
...
{
       9,     0,    -1,    10,    20,    13,    -1,    11,    -1,    11,
      12,    -1,    12,    -1,    16,    -1,    14,    20,    -1,    13,
      14,    19,    -1,    13,    14,    -1,    14,    -1,    15,    -1,
      16,    -1,    15,    16,    -1,    17,    -1,    17,    18,    -1,
      18,    -1,     7,    -1,     3,    -1,    19,    20,    -1,    20,
      -1,    21,    -1,     4,    -1,     5,    -1,     6,    -1
};
...
{
       0,    57,    57,    60,    68,    68,    70,    72,    72,    72,
      72,    75,    81,    81,    83,    83,    85,    96,   142,   144,
     144,   147,   152,   152,   152
};
#endif
...
{
  "$end", "error", "$undefined", "COMMA", "CRLF", "CR", "LF", "TEXTDATA",
  "$accept", "file", "header", "names", "name", "c_records", "record",
  "fields", "field", "textdata", "comma", "ENTERS", "ENTER", "ENTER_", 0
};
#endif
...
{
       0,    18,    17,     0,     0,     3,     5,     6,    14,    16,
       1,    22,    23,    24,     0,    21,     4,    15,     2,    10,
      11,    12,     9,     7,    13,     8,    20,    19
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,     4,     5,     6,    18,    19,    20,     7,     8,
       9,    25,    14,    15
};
...
{
       0,   -18,   -18,     1,     5,     0,   -18,   -18,     9,   -18,
     -18,   -18,   -18,   -18,     0,   -18,   -18,   -18,     0,     5,
       0,   -18,     5,   -18,   -18,     5,   -18,   -18
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -18,   -18,   -18,   -18,     8,   -18,    -4,   -18,   -14,   -18,
       7,   -18,   -17,   -18
};
...
{
      21,    10,    23,     1,    21,    26,    24,     2,    27,    11,
      12,    13,     1,    16,    22,    17
};

static const yytype_uint8 yycheck[] =
{
      14,     0,    19,     3,    18,    22,    20,     7,    25,     4,
       5,     6,     3,     5,    18,     8
};
...
{
       0,     3,     7,     9,    10,    11,    12,    16,    17,    18,
       0,     4,     5,     6,    20,    21,    12,    18,    13,    14,
      15,    16,    14,    20,    16,    19,    20,    20
};
...
#line 96 "hw4.y"
    ...
    if (len > 1 && (yyvsp[(1) - (1)].sval)[0] == '"' && (yyvsp[(1) - (1)].sval)[len - 1] == '"'){
      /* as described in pizza, we need to check whether quote match */
      quoted = true;
      char* temp = malloc((len + 1) * sizeof(char));
      strcpy(temp, (yyvsp[(1) - (1)].sval) + 1);
      temp[strlen(temp) - 1] = '\0';
      free((yyvsp[(1) - (1)].sval));
      (yyvsp[(1) - (1)].sval) = temp;
    }
    else if ((yyvsp[(1) - (1)].sval)[0] == '"' || (yyvsp[(1) - (1)].sval)[len - 1] == '"'){
      return 1;
    }
    else{
      quoted = false;
    ...
    if (!reading_records){
      ...
      if (strcmp((yyvsp[(1) - (1)].sval), "name") == 0)
        if (name_index != -1){
          return 1;
        }
        else{
      ...
      if (strlen((yyvsp[(1) - (1)].sval)) == 0){
        char* mal = malloc(6*sizeof(char));
        strcpy(mal, "empty");
        free((yyvsp[(1) - (1)].sval));
        (yyvsp[(1) - (1)].sval) = mal;
      }
      if (!add((yyvsp[(1) - (1)].sval))){
        free((yyvsp[(1) - (1)].sval));
      }
    }
   ;}
